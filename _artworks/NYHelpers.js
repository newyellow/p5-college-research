...
/**
 * Hashes a string into a 32-bit integer and sets randomSeed and noiseSeed.
 * Useful for consistent results when the seed is a string.
 */
function seedPRNG(seedString) {
    ...
    let randomSeedValue = (h1 ^ h2) >>> 0;
    let noiseSeedValue = (h3 ^ h4) >>> 0;
    
    randomSeed(randomSeedValue);
    noiseSeed(noiseSeedValue);

    console.log("randomSeedValue: " + randomSeedValue);
    console.log("noiseSeedValue: " + noiseSeedValue);
